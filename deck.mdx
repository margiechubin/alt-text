...
You can use <Link href="https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/docs/rules/alt-text.md">eslint-plugin-jsx-a11y</Link>'s rule for alt-text.
